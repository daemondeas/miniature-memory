...
public class Input19 : AbstractInput<List<Blueprint>, List<Blueprint>>
{
    protected override List<Blueprint> ParseInput(string input) => input.Split('\n').Select(ParseBlueprint).ToList();
    ...
    private static Blueprint ParseBlueprint(string row)
    {
        ...
        return new Blueprint
        {
            ...
            ObsidianRobotOreCost = int.Parse(parts[18]),
            ObsidianRobotClayCost = int.Parse(parts[21]),
            GeodeRobotOreCost = int.Parse(parts[27]),
            GeodeRobotObsidianCost = int.Parse(parts[30])
        };
    }

    protected override List<Blueprint> ParseInputTwo(string input) => ParseInput(input);

    protected override long SolveFirstPuzzle(List<Blueprint> input) => Day19.FirstPuzzle(input);

    protected override long SolveSecondPuzzle(List<Blueprint> input) => Day19.SecondPuzzle(input);

    public override string TestInput =>
        "Blueprint 1: Each ore robot costs 4 ore. Each clay robot costs 2 ore. Each obsidian robot costs 3 ore and 14 clay. Each geode robot costs 2 ore and 7 obsidian.\nBlueprint 2: Each ore robot costs 2 ore. Each clay robot costs 3 ore. Each obsidian robot costs 3 ore and 8 clay. Each geode robot costs 3 ore and 12 obsidian.";
    public override string RealInput => @"Blueprint 1: Each ore robot costs 4 ore. Each clay robot costs 4 ore. Each obsidian robot costs 4 ore and 20 clay. Each geode robot costs 2 ore and 12 obsidian.
